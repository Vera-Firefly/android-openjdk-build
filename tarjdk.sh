...
findexec jreout | xargs --alignment 64 --api-level 24 ./termux-elf-cleaner/build/termux-elf-cleaner
findexec jdkout | xargs --alignment 64 --api-level 24 ./termux-elf-cleaner/build/termux-elf-cleaner
