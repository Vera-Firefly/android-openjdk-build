...
findexec jreout | xargs --api-level 24 ./termux-elf-cleaner/build/termux-elf-cleaner
findexec jdkout | xargs --api-level 24 ./termux-elf-cleaner/build/termux-elf-cleaner
